  ...
  return (
    <View style={globals.container}>
      <Pressable>
        <View style={Seating.container}>
          <View style={Seating.topper}>
            <Text style={Seating.topper_text}>Seating Plan</Text>
          </View>

          <View style={Seating.loser}>
            <Text style={Seating.loser_text}>{seat}</Text>
          </View>
        </View>
      </Pressable>
      ...
      <Pressable>
        <View style={Seating.container}>
          <View style={Seating.topper}>
            <Text style={Seating.topper_text}>Attendance</Text>
          </View>
